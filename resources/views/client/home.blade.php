        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              <h1>
                Dịch vụ sửa chữa trực tuyến
              </h1>
              <p>
                Cung cấp các giải pháp sửa chữa chất lượng cao cho gia đình của bạn
              </p>
              <a href="">
                Liên hệ ngay
              </a>
          ...
          <div class="col-md-6">
            <div class="img-box">
              <img src="{{asset('client/images/slider-img.png')}}" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
              Bạn đang tìm kiếm một đội ngũ sửa chữa đáng tin cậy để giải quyết các vấn đề kỹ thuật trong gia đình của mình? Hãy để chúng tôi giúp bạn!

Với kinh nghiệm nhiều năm trong ngành và đội ngũ kỹ thuật viên tài năng, chúng tôi tự hào cung cấp các dịch vụ sửa chữa chất lượng cao trên khắp mọi nơi trên toàn quốc.
            </p>
            <a href="">
              Xem thêm
            </a>
        ...
        <div class="col-lg-7 col-md-6">
          <div class="img-box">
            <img src="{{asset('client/images/about-img.jpg')}}" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="professional_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="{{asset('client/images/professional-img.png')}}" alt="">
          </div>
        </div>
        <div class="col-md-6 ">
          <div class="detail-box">
            <h2>
              CHÚNG TÔI CUNG CẤP CHUYÊN NGHIỆP
              DỊCH VỤ
              TẠI NHÀ 
            </h2>
            <p>
              Chúng tôi cung cấp một loạt các dịch vụ sửa chữa, từ sửa nhà, sửa điện, sửa nước, đến sửa máy lạnh, sửa máy giặt và nhiều hơn nữa. Không có công việc nào quá lớn hoặc quá nhỏ đối với chúng tôi.
            </p>
            <a href="">
              Xem thêm
            </a>
    ...
    <div class="container ">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="{{asset('client/images/s1.png')}}" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Maintenance
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="{{asset('client/images/s2.png')}}" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Electrical
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            <div class="img-box">
              <img src="{{asset('client/images/s3.png')}}" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Plumbing
